...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "outbounddelivery/test/integration/FirstJourney",
    "outbounddelivery/test/integration/OutboundDeliveryListJourney",
    "outbounddelivery/test/integration/OutboundDeliveryObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
