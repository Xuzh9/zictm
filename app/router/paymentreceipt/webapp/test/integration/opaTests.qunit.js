...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "paymentreceipt/test/integration/FirstJourney",
    "paymentreceipt/test/integration/PaymentReceiptListJourney",
    "paymentreceipt/test/integration/PaymentReceiptObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
